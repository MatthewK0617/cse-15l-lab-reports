...
After making the necessary revisions, press **Esc** (the escape key) to stop inserting. Entering `:w` will then save your file, which you can then exit using the command `:q`.
